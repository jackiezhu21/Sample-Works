...
public class StudentTests {
    ...
    @Test(timeout = 500)
    public void basicDisjointTestSameSet1() {
        DisjointSets<String> disjointSet = makeBasicDisjointSet();
    ...
    @Test(timeout = 500)
    public void disjointMergeWithSimilarElements1() {
        HashSet<String> set = new HashSet<String>();
        set.add("a");
        set.add("b");
        set.add("c");
